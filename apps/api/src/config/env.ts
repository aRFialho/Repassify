...
const envSchema = z.object({
  ...
  SHOPEE_TEST_PARTNER_ID: z.string().optional(),
  SHOPEE_TEST_PARTNER_KEY: z.string().optional(),
  SHOPEE_LIVE_PARTNER_ID: z.string().optional(),
  SHOPEE_LIVE_PARTNER_KEY: z.string().optional(),
